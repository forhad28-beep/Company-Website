...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Register In | Company Website</title>
    ...
    <body class="bg-white">
        ...
        <form method="POST" action="{{ route('register') }}" class="my-4">
            ...
            <div class="form-group mb-3">
                ...
                <input class="form-control" type="password" id="password_confirmation" name="password_confirmation" required="" placeholder="Enter your Confirm Password">
            </div>
                    ...
                    <div class="d-grid">
                        <button class="btn btn-primary" type="submit"> Register </button>
                                        ...
                                        <div class="text-center text-muted mb-4">
                                            <p class="mb-0">Do you have an account ?<a class='text-primary ms-2 fw-medium' href='{{ route('login') }}'>Sing In</a></p>
                                        </div>
